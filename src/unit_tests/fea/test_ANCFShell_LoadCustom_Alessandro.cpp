...
int main(int argc, char* argv[]) {
	...
	// Adding load using Alessandro stuff
   ...
   class MyLoadCustomMultiple : public ChLoadCustomMultiple {
    public:   
            ...
            virtual void ComputeQ(ChState*      state_x, ///< state position to evaluate Q
				...
				double detJ0 = 1.0; // Assume initial Jacobian has determinant one
				...
				/*this->load_Q(2) = 0.2; // Fz 1
                //this->load_Q(5) = 0.0 ; // RFz 1
				this->load_Q(8) = 0.2; // Fz 2
				//this->load_Q(11) = 0.0; // RFz 2
				this->load_Q(14) = 0.2; // Fz 3 
				//this->load_Q(17) = 0.0; // RFz 3 
				this->load_Q(20) = 0.2;// Fz 4 
				//this->load_Q(23) = 0.0;// RFz 4 */
				// if (my_system.GetChTime()> )
   ...
   mloadcontainer->Add(mloadcustommultiple);
    ...
    for (unsigned int it = 0; it < num_steps; it++) {
       ...
       // double AbsVal = abs(nodetip->pos.z - FileInputMat[it][1]);
        ...
        //    return 1;
        // }
	//std::cout << "NodeLoad6->pos.z = " << NodeLoad6->pos.z << "\n";
	//std::cout << "NodeLoad7->pos.z = " << NodeLoad7->pos.z << "\n";
	//std::cout << "NodeLoad11->pos.z = " << NodeLoad11->pos.z << "\n";
	//std::cout << "NodeLoad12->pos.z = " << NodeLoad12->pos.z << "\n"; 
		std::cout << "NodeLoad11->pos.z = " << NodeLoad11->pos.z << "\n";
		std::cout << "mystepper->GetNumIterations()= " << AccuNoIterations << "\n";
	AccuNoIterations += mystepper->GetNumIterations();
	m_data[0][it] = my_system.GetChTime();
	m_data[1][it] = NodeLoad11->pos.z;
